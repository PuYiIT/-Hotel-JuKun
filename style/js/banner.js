...
c = "<div class='rslides_div container'><a href='#' class='" + y + " prev'>" + b.prevText + "</a><a href='#' class='" + y + " next'>" + b.nextText + "</a></div>"; h.controls ? d(b.controls).append(c) : e.after(c); var c = d("." + g + "_nav"), B = d("." + g + "_nav.next"); c.bind("click", function (a) { // 非响应式去除 container
...
} if ("undefined" === typeof document.body.style.maxWidth && h.maxwidth) { var C = function () { e.css("black", "100%"); e.width() > r && e.css("black", r) }; C(); d(D).bind("resize", function () { C() }) } 
})
} 
})(jQuery, this, 0);
$(function () {
