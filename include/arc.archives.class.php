    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<a href='$mlink' class='btn btn-success mb-none m-x-20'>← {$preRow['title']}</a> ";
                $this->PreNext['preimg'] = "<a href='$mlink'><img src=\"{$preRow['litpic']}\" alt=\"{$preRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['pre'] = "<a href='#' class='btn btn-success mb-none m-x-20'>哎呦，没有了哦！</a> ";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<a href='$mlink' class='btn btn-success mb-none m-x-20'>{$nextRow['title']} →</a> ";
                $this->PreNext['nextimg'] = "<a href='$mlink'><img src=\"{$nextRow['litpic']}\" alt=\"{$nextRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['next'] = "<a href='#' class='btn btn-success mb-none m-x-20'>哎呦，没有了哦！</a> ";
